...
my_w = tk.Tk()
my_w.geometry("1200x1200")  # Size of the window 
my_w.title('Face Entry System')

# Name
name_text = StringVar()
name_label = Label(my_w, text='Name', font=('bold', 40), pady=20)
